...
//using static json_dosya_okuma_ve_2li_sistemden_10luk_sayıya_cevirme.dto_class;
//using static json_dosya_okuma_ve_2li_sistemden_10luk_sayıya_cevirme.veribaglanti;
...
namespace json_dosya_okuma_ve_2li_sistemden_10luk_sayıya_cevirme
{
    public partial class Form1 : Form
    {
        ...
        // kullanıcı DGV listesi servis ile doldurulacak.
        // satıra tıklanıldığında kullanıcı access sayfası ilgili kullanıcı formunu açacak



        // Constructor Kullanıcı dtosu ile çalışacak
        // dtodan gelen read ve write accessler dgv dolduracak
        ...
        {
            //veribaglantisi veribaglanti = new veribaglantisi();
